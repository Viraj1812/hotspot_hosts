...
void main(List<String> args) {
  ...
  const projectName = 'hotspot_hosts'; //! Add your project name here
...
import 'package:$projectName/features/$featureName/controller/${featureName}_state.dart';
...
''';
  ...
  // Create files
  _createFile('$basePath/controller/${featureName}_state_notifier.dart', stateNotifierContent);
  _createFile('$basePath/controller/${featureName}_state.dart', stateContent);
  _createFile('$basePath/repository/${featureName}_repository.dart', repositoryContent);
  _createFile('$basePath/view/${featureName}_screen.dart', screenContent);
